...
# GitHub: https://github.com/1bendzi/HOP-Streamlined.git
...
with open(f"HOP-Streamlined\Generated Evidence\HOP_{scheme_name}_Evidence.txt", encoding='utf8') as scheme_page_evidence:
...
with open("HOP-Streamlined\Generated Evidence\HOP_Corvidae_Evidence.txt", encoding='utf8') as demo_page_evidence:
...
evidence_file_diff = open(f"HOP-Streamlined\Demo vs Scheme - evidence\HOP_{scheme_name}_compared_to_demo.txt","a", encoding="utf-8")
